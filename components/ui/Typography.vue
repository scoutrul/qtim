...
const variantClasses = computed(() => TYPOGRAPHY.VARIANTS[props.variant.toUpperCase() as keyof typeof TYPOGRAPHY.VARIANTS])
const fontWeightClass = computed(() => TYPOGRAPHY.WEIGHTS[props.weight.toUpperCase() as keyof typeof TYPOGRAPHY.WEIGHTS])
