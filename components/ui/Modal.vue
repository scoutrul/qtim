<script setup lang="ts">
  ...
  const handleBackdropClick = (e: MouseEvent) => {
    if (!props.persistent && modalContent.value && !modalContent.value.contains(e.target as Node)) {
      close()
    }
  }
      ...
      >
        ...
        >
          ...
          >
            ...
            <!-- Основное содержимое -->
            <div
              class="p-4 sm:p-6 overflow-y-auto"
              :style="{ maxHeight: fullscreen ? 'calc(100vh - 120px)' : 'calc(70vh - 120px)' }"
            >
              <slot></slot>
            </div>
